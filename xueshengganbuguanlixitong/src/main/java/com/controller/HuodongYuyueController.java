    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(huodongYuyue !=null){
            ...
            //级联表 学生
            //级联表
            XueshengEntity xuesheng = xueshengService.selectById(huodongYuyue.getXueshengId());
            if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody HuodongYuyueEntity huodongYuyue, HttpServletRequest request){
        ...
        if(false)
            ...
            huodongYuyue.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));

        Wrapper<HuodongYuyueEntity> queryWrapper = new EntityWrapper<HuodongYuyueEntity>()
            .eq("huodong_id", huodongYuyue.getHuodongId())
            .eq("xuesheng_id", huodongYuyue.getXueshengId())
            ;
...
//            huodongYuyue.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<HuodongYuyueEntity> queryWrapper = new EntityWrapper<HuodongYuyueEntity>()
            ...
            .eq("huodong_yuyue_yesno_types", huodongYuyue.getHuodongYuyueYesnoTypes())
            .eq("huodong_yuyue_yesno_text", huodongYuyue.getHuodongYuyueYesnoText())
            .eq("huodong_yuyue_shenhe_time", huodongYuyue.getHuodongYuyueShenheTime())
            .eq("insert_time", huodongYuyue.getInsertTime())
            ;
...
//                            huodongYuyueEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
