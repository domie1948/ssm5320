...
public class CommonController{
	 ...
	 * 分组统计
	 */
	@RequestMapping("/group/{tableName}/{columnName}/{xueshengToupiaoId}")
	@IgnoreAuth
	public R group(@PathVariable("tableName") String tableName, @PathVariable("columnName") String columnName, @PathVariable("xueshengToupiaoId") String xueshengToupiaoId) {
		Map<String, Object> params = new HashMap<String, Object>();
		params.put("table", tableName);
		params.put("column", columnName);
		params.put("xueshengToupiaoId", xueshengToupiaoId);
