    ...
    */
    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(huodongCollection !=null){
            ...
            //级联表 学生
            //级联表
            XueshengEntity xuesheng = xueshengService.selectById(huodongCollection.getXueshengId());
            if(xuesheng != null){
    ...
    */
    ...
    public R save(@RequestBody HuodongCollectionEntity huodongCollection, HttpServletRequest request){
        ...
        if(false)
            ...
            huodongCollection.setXueshengId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<HuodongCollectionEntity> queryWrapper = new EntityWrapper<HuodongCollectionEntity>()
            ...
            .eq("xuesheng_id", huodongCollection.getXueshengId())
...
//                            huodongCollectionEntity.setXueshengId(Integer.valueOf(data.get(0)));   //学生 要改的
