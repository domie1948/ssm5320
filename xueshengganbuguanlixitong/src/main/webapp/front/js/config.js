...
var centerMenu = [
    ...
    ,{
        name: '投票',
        url: '../xueshengToupiao/list.html'
    }
    ,{
        name: '投票详情',
        url: '../xueshengToupiaoList/list.html'
    }
...
var adminurl =  "http://localhost:8080/xueshengganbuguanlixitong/admin/dist/index.html#/login";
