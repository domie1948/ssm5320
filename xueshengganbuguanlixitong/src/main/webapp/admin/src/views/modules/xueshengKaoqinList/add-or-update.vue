    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='xueshengKaoqin'">
                    <el-form-item class="select" v-if="type!='info'"  label="考勤" prop="xueshengKaoqinId">
                        <el-select v-model="ruleForm.xueshengKaoqinId" :disabled="ro.xueshengKaoqinId" filterable placeholder="请选择考勤" @change="xueshengKaoqinChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='xueshengKaoqin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="考勤唯一编号" prop="xueshengKaoqinUuidNumber">
                        <el-input v-model="xueshengKaoqinForm.xueshengKaoqinUuidNumber"
                                  placeholder="考勤唯一编号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="考勤唯一编号" prop="xueshengKaoqinUuidNumber">
                            <el-input v-model="ruleForm.xueshengKaoqinUuidNumber"
                                      placeholder="考勤唯一编号" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='xueshengKaoqin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="考勤标题" prop="xueshengKaoqinName">
                        <el-input v-model="xueshengKaoqinForm.xueshengKaoqinName"
                                  placeholder="考勤标题" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="考勤标题" prop="xueshengKaoqinName">
                            <el-input v-model="ruleForm.xueshengKaoqinName"
                ...
                <el-col :span="12"  v-if="sessionTable !='xueshengKaoqin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="考勤截止时间" prop="jiezhiTime">
                        <el-input v-model="xueshengKaoqinForm.jiezhiTime"
            ...
            <input id="xueshengKaoqinId" name="xueshengKaoqinId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="打卡状态" prop="xueshengKaoqinListTypes">
                        <el-select v-model="ruleForm.xueshengKaoqinListTypes" :disabled="ro.xueshengKaoqinListTypes" placeholder="请选择打卡状态">
                            <el-option
                                v-for="(item,index) in xueshengKaoqinListTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="打卡状态" prop="xueshengKaoqinListValue">
                        <el-input v-model="ruleForm.xueshengKaoqinListValue"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    xueshengId: false,
                    xueshengKaoqinId: false,
                    xueshengKaoqinListTypes: false,
                    insertTime: false,
                    updateTime: false,
                },
                ruleForm: {
                    xueshengId: '',
                    xueshengKaoqinId: '',
                    xueshengKaoqinListTypes: '',
                    insertTime: '',
                    updateTime: '',
                },
                xueshengKaoqinListTypesOptions : [],
                xueshengOptions : [],
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=xuesheng_kaoqin_list_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengKaoqinListTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            xueshengKaoqinChange(id){
                this.$http({
                    url: `xueshengKaoqin/info/`+id,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.xueshengKaoqinForm = data.data;
                    }
                });
            },
            // 多级联动参数
            info(id) {
                let _this =this;
                _this.$http({
                    url: `xueshengKaoqinList/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.xueshengChange(data.data.xueshengId)
                        _this.xueshengKaoqinChange(data.data.xueshengKaoqinId)
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`xueshengKaoqinList/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.xueshengKaoqinListCrossAddOrUpdateFlag = false;
                                        this.parent.search();
