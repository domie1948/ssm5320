            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-else-if="scope.row.ganbuId">
                            干部
                        </span>
                        <span v-else>
                            管理员
...
|| (sessionTable == 'ganbu' && scope.row.ganbuId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xueshengganbuguanlixitong/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.ganbuId = el.ganbuId;//---
                            forum.ganbuName = el.ganbuName;
                            forum.ganbuPhone = el.ganbuPhone;
                            forum.ganbuIdNumber = el.ganbuIdNumber;
                            forum.ganbuPhoto = el.ganbuPhoto;
                            forum.banjiTypes = el.banjiTypes;
                            forum.zhiweiTypes = el.zhiweiTypes;
                            forum.ganbuEmail = el.ganbuEmail;
                            forum.createTime = el.createTime;
