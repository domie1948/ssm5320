    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="通知名称" prop="gonggaoName">
                       <el-input v-model="ruleForm.gonggaoName"
                                 placeholder="通知名称" clearable  :readonly="ro.gonggaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="通知名称" prop="gonggaoName">
                           <el-input v-model="ruleForm.gonggaoName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.gonggaoPhoto" label="通知图片" prop="gonggaoPhoto">
                        <file-upload
                            tip="点击上传通知图片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.gonggaoPhoto" label="通知图片" prop="gonggaoPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="通知类型" prop="gonggaoTypes">
                        <el-select v-model="ruleForm.gonggaoTypes" :disabled="ro.gonggaoTypes" placeholder="请选择通知类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="通知类型" prop="gonggaoValue">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="通知详情" prop="gonggaoContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gonggaoContent" label="通知详情" prop="gonggaoContent">
