...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   ganbuId: [
                              { required: true, message: '干部不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
         ...
         this.$http({
             url: `ganbu/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.ganbuOptions = data.data.list;
            }
         });
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ganbuChange(data.data.ganbuId)
                    } else {
